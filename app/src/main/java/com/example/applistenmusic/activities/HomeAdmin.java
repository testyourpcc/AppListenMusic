...
public class HomeAdmin extends AppCompatActivity {
    ...
    ImageView HomeFeature, HomeFeature1, HomeFeatureClose, Home,Search,Play,Account;
    LinearLayout menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HomeFeature1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (menu.getVisibility() == View.VISIBLE) {
                    menu.setVisibility(View.INVISIBLE);
        ...
        adapterKpopSong.setOnItemClickListener(new SongAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int id) {
                Intent playIntent = new Intent(HomeAdmin.this, PlayView.class);
        ...
        adapterVpopSong.setOnItemClickListener(new SongAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(int id) {
                Intent playIntent = new Intent(com.example.applistenmusic.activities.HomeAdmin.this, PlayView.class);
                SongSingleton.getInstance().setSong(SongHelper.getSongById(SongListSingleton.getInstance().getAllSongIfExist(),id));
                playIntent.putExtra("playNow",true);
                startActivity(playIntent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
    ...
    public void setcontrol() {
        ...
        HomeFeature1 = findViewById(R.id.imageViewFeature);
